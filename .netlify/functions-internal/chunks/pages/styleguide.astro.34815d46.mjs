/* empty css                         */import { c as createAstro, a as createComponent, r as renderTemplate, d as renderComponent, m as maybeRenderHead, b as addAttribute } from '../astro.11cd3780.mjs';
import 'html-escaper';
...
const $$Styleguide = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "description": "Style guide for Stone premium Astro theme", "title": "Styleguide \xB7 Betts" }, { "default": ($$result2) => renderTemplate`
  ...
  <section class="py-16 sm:py-20">
    <div class="mx-auto max-w-2xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
      <div class="flex flex-col gap-16">
        <h2 class="text-3xl font-medium tracking-tight sm:text-4xl">Colors</h2>
        <div class="grid grid-cols-2 gap-12 sm:grid-cols-6">
          ${colors.map((color) => renderTemplate`<div class="relative flex">
                <div class="flex flex-col gap-2">
                  <div class="h-16 w-16 rounded-md border border-primary-900/10 dark:border-primary-300/10"${addAttribute(`background-color: ${color.hex}`, "style")}></div>
      ...
      <div class="flex flex-col gap-16">
        ...
        <div class="flex flex-col gap-16 sm:flex-row">
          <div class="flex flex-col gap-8">
            <div class="flex w-64 flex-col items-center gap-3 rounded-md bg-primary-500/10 p-6 dark:bg-primary-400/10">
            ...
            <div class="flex w-64 flex-col items-center gap-3 rounded-md bg-primary-500/10 p-6 dark:bg-primary-400/10">
              <p class="text-5xl font-medium">Aa</p>
              <p class="text-base text-primary-950/70 dark:text-primary-200/70">
                Inter Medium
              </p>
            </div>
          ...
          <div class="flex flex-col gap-4">
            ...
            <h3 class="text-xl font-medium sm:text-2xl">Heading 3</h3>
            <p class="text-lg sm:text-xl">Subtitle</p>
            <p class="text-base font-medium">Bold text</p>
            <p class="text-base">
