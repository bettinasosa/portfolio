...
/* empty css                          */
import { T as Tilt } from './gallery_629c928a.mjs';
...
const $$MarkDownProjectLayout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, 'Layout', $$Layout, { 'description': 'My personal portfolio website.' }, {
    'default': ($$result2) => renderTemplate`${renderComponent($$result2, 'ProjectHero', $$ProjectHero, {
      'title': frontmatter.title,
      'description': frontmatter.description,
      'isImage': frontmatter.isImage,
      'heroImage': frontmatter.image
    })}${renderComponent($$result2, 'Body', $$Body, {
      'subtitle': frontmatter.subtitle,
      'description': frontmatter.description,
      'introduction': frontmatter.introduction,
      'myRole': frontmatter.myRole,
      'paragraphs': frontmatter.paragraphs,
      'secondaryImages': frontmatter.secondaryImages,
