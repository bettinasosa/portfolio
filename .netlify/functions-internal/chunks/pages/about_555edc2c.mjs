...
const $$About = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$About;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "description": "More about me.", "title": "About \xB7 Bettina" }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "Heading", $$Heading, {})}${renderComponent($$result2, "Mission", $$About$1, {})}` })}<!--add a link to my cv and my portfolio-->`;
